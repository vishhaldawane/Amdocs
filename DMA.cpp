...
class Flight
{
	...
	public:
		...
		~Flight() {
			cout<<"\nDestructor of Flight()...."<<flightName;
		}
...
*/

	{
		int i=100;
		cout<<"\nbegin of scope2";
		Flight flight3(103,"British Airways","Mumbai","London");

		Flight *ptr = new Flight(102,"AirIndia","New Delhi","Kolkatta");
		ptr->print();
		cout<<"\nend of scope2";
		//delete ptr; //destroy the object which is allocated using
		//the new keyword
	}
	//2 hours of coding going on for execution
	cout<<"\nEnd of main\n";
	return 0;
}
